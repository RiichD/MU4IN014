...
filename = "immu_period_data.txt" #Nom du fichier qui permet de réaliser les graphiques

out_name = "immu_period" #Fichiers de sortie contenant ce nom, ainsi qu'un sous-dossier de ce nom
...
f9 = pyplot.figure(9)
histogram_builder("Time in iteration", "Density", "Time histogram", True, 10, f"{out_path}time_hist_{out_name}.pdf", tab_time, list(range(0, 1000, 100)))
f8 = pyplot.figure(8)
heatmap_builder(120, list(range(0,15)), "Time heatmap", f"{out_path}time_heat_{out_name}.pdf", tab_time)
f7 = pyplot.figure(7)

#MAX
graph_builder("Time in iteration", "Infected", "Maximum infection graph", 1, 10000, f"{out_path}max_graph_{out_name}.pdf", tab_max_infec, list(range(0, 100, 25))+list(range(200, 600, 100)))
f6 = pyplot.figure(6)
histogram_builder("Maximum infected", "Density", "Maximum infected histogram", True, 10, f"{out_path}max_hist_{out_name}.pdf", tab_max_infec, list(range(0, 1000, 25)))
f5 = pyplot.figure(5)
...
f2 = pyplot.figure(2)
heatmap_builder(200, list(range(0,15)), "Multi-infections heatmap", f"{out_path}mult_heat_{out_name}.pdf", tab_mult_infec)
pyplot.show()
